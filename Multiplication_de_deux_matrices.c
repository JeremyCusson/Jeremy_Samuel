/********
 ...
 Description: Calcul d'une multiplication de deux matrices carrées
              et tests du fonctionnement du codage
********/

#include <stdio.h>
#define n 5

void TestMultiplicationMatrices(double matrice1[n][n], double matrice2[n][n], double matrice3[n][n]);

// Description: Opération de la multiplication de deux matrices
int main(void)
{	
	...
	TestMultiplicationMatrices(matrice1, matrice2, matrice3);
	...
	TestMultiplicationMatrices(matriceTest1, matriceTest2, matrice3);
	printf("-------------------------------------------\n");
	...
	TestMultiplicationMatrices(matriceTest3, matriceTest4, matrice3);
	printf("-------------------------------------------\n");
	
	return 0;
}

//Description: Tests, selon les matrices paramétrées
//Précondition: Matrice carré avec le même nombre de colonnes et de lignes
//Postecondition: Matrice résultante possède le même nombre de colonnes et de lignes que les autres matrices
void TestMultiplicationMatrices(double matrice1[n][n], double matrice2[n][n], double matrice3[n][n])
{
	int nombreColonneLigne = 0;
